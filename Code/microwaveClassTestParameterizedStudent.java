...
public class microwaveClassTestParameterizedStudent {
...
//			Test case 2
    ...
    public microwaveClassTestParameterizedStudent(boolean cooking, boolean doorOpen, boolean stopButton, int timer, boolean cookState_res, boolean stop_res, int timer_res) {
